...
# Prepare GPIO for program usage
GPIO.setwarnings(False)
Buzzer_Pin = 7 #the internal Pi pin number that goes to snap 7
...
# Turn horn on at race completion
...
# Clean up GPIO resources for next applications usage
GPIO.cleanup() 
